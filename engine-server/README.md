...
Then point the Mac frontend at `http://100.65.146.62:8765`. If Windows refuses to bind to that address, use `HOST=0.0.0.0` and keep accessing it from the Mac through the same Tailscale IP.
