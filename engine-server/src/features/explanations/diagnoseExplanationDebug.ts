...
function diagnoseChoice(params: {
  ...
  if (wrongChoice) {
    ...
    const usesOwnEvidence = hasChoiceSpecificEvidence(explanation, factPhrases) || usesContrastPhrase;
